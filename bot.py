...
from msgs import hlp,hi,info,infos,s1,ecole,kindy,subjects,coor,coordinator,creator,creators,inters
from decouple import config


#BOT_TOKEN = "5928892637:AAGGTaAY0wIXn8KvVo-fu_hfmzNC32jx0bI"
...
def reply(message):
    ...
    if words[0].lower() in inters :
        return bot.reply_to(message,"Interviews : https://www.udrop.com/7Kx4/ML.rar") 
